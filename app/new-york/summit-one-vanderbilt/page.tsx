  ...
  return (
    <main style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <section style={{ maxWidth: 960, margin: "0 auto", padding: "64px 24px" }}>
        <h1>SUMMIT One Vanderbilt — Best Value Options</h1>
        <p>
          TripSage recommends the best value ways to visit SUMMIT One Vanderbilt
          based on price, flexibility, and availability.
        </p>
        ...
        <div style={{ border: "1px solid #eee", borderRadius: 8, padding: 16, marginTop: 16 }}>
          ...
          <p>Price: $XX</p>
          <p>Why: Available today or tomorrow</p>
          <a href="#" style={{ color: "#1F3A5F", fontWeight: 600 }}>
            Buy Ticket →
          </a>
        </div>
        ...
        <div style={{ border: "1px solid #eee", borderRadius: 8, padding: 16, marginTop: 16 }}>
          ...
          <p>Price: $XX</p>
          <p>Why: Child pricing available</p>
          <a href="#" style={{ color: "#1F3A5F", fontWeight: 600 }}>
            Buy Ticket →
          </a>
        </div>
