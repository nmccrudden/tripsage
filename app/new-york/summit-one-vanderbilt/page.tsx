...
export const metadata: Metadata = {
  title: "SUMMIT One Vanderbilt Tickets (Best Deals & Skip-the-Line) | TripSage",
  description:
    "Compare SUMMIT One Vanderbilt ticket prices, skip-the-line access, and refundable options. Find the best deal and avoid overpaying with TripSage.",
};

export default function SummitOneVanderbiltPage() {
  return (
    <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "60px 24px", fontFamily: "system-ui" }}>
      ...
      <h1 style={{ fontSize: "42px", marginTop: "16px" }}>
        SUMMIT One Vanderbilt Tickets – Compare the Best Deals
      </h1>

      <p style={{ fontSize: "18px", color: "#555", maxWidth: "720px", marginTop: "12px" }}>
        Compare SUMMIT One Vanderbilt tickets across trusted platforms to find the best price, flexible
        cancellation options, and last-minute availability — with minimal fuss.
      </p>
      ...
      <section style={{ marginTop: "48px", display: "grid", gap: "20px" }}>
        <div style={cardStyle}>
          ...
          <a href="/out/vanderbilt" style={buttonStyle} target="_blank" rel="noopener noreferrer">
            View best deal
          </a>
        </div>
