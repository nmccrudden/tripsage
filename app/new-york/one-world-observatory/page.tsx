    ...
    <main style={{ fontFamily: "system-ui", color: "#111" }}>
      ...
      <section style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
          {[
            { title: "Best value overall", label: "View best deal" },
            { title: "Best refundable option", label: "View refundable ticket" },
            { title: "Best for late planners", label: "View last-minute options" },
          ].map((item) => (
            <div
              key={item.title}
              style={{
