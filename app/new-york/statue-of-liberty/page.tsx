...
export default function StatueOfLiberty() {
  return (
    <main style={{ padding: "60px 24px", fontFamily: "system-ui", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <h1 style={{ fontSize: "42px", marginTop: "16px" }}>Statue of Liberty Tickets</h1>

      <p style={{ fontSize: "18px", color: "#555", maxWidth: "700px" }}>
        TripSage compares Statue of Liberty ticket options based on price, flexibility, and how far in advance you book.
      </p>
      ...
      <div style={{ display: "grid", gap: "20px", marginTop: "40px" }}>
        <div style={cardStyle}>
          ...
          <a
            href="PASTE_STATUE_OF_LIBERTY_AFFILIATE_LINK_HERE"
            target="_blank"
